            ...
            <div className="d-flex gap-2 w-100 justify-content-between">
                <div className="flex-grow-1">
                    <div className="d-flex flex-fill align-items-center">
                        <Time unsavedChanges={unsavedChanges} setUnsavedChanges={setUnsavedChanges} _id={_id} timeRef={timeRef} time={time} day={day}/>
                        <Title unsavedChanges={unsavedChanges} setUnsavedChanges={setUnsavedChanges} title={title} titleRef={titleRef}/>
                    </div>
                </div>
                <div className="flex-grow-0 d-flex align-items-center">
                    <div className="d-flex">
                        <Organizers unsavedChanges={unsavedChanges} setUnsavedChanges={setUnsavedChanges} organizers={organizers} setOrganizers={setOrganizers}/>
                        <div className="d-flex column-settings h-25 m-1 align-items-center justify-content-center ml-auto">
                            <button onClick={deleteColumn} className='weight-500 column-settings-inner text-wrap'>X</button>
                        </div>
                    </div>
                </div>
            </div>
